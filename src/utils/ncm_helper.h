...
const char* const WEB_API_RSA_PUBKEY_N = "0x00e0b509f6259df8642dbc35662901477df22677ec152b5ff68ace615bb7b725152b3ab1"
...
const char* const CLI_API_DATA_SALT = "%(url)s-36cd479b6b5-%(text)s-36cd479b6b5-%(digest)s";
const char* const CLI_API_AES_KEY = "e82ckenh8dichen8";    // ecb
const char* const BASE62 = "PJArHa0dpwhvMNYqKnTbitWfEmosQ9527ZBx46IXUgOzD81VuSFyckLRljG3eC";
const char* const CLI_API_UA = "NeteaseMusic/7.2.24.1597753235(7002024);Dalvik/2.1.0 (Linux; U; Android "
...
QByteArray inline getDecryptedData(const QString& comment) {
    ...
    modifyDecryptData =
        modifyDecryptData.left(modifyDecryptData.length() - modifyDecryptData[modifyDecryptData.length() - 1]);
