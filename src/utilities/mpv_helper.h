 ...
 */
    struct node_auto_free {
        ...
        explicit node_auto_free(mpv_node *a_ptr)
                : ptr(a_ptr) {
        }
 ...
 */
    static inline QVariant
    get_property_variant(mpv_handle *ctx, const QString &name) {
        mpv_node node;
 ...
 */
    static inline int
    set_property_variant(mpv_handle *ctx, const QString &name, const QVariant &v) {
        node_builder node(v);
        return mpv_set_property(
                ctx, name.toUtf8().data(), MPV_FORMAT_NODE, node.node());
    }
 ...
 */
    static inline int
    set_option_variant(mpv_handle *ctx, const QString &name, const QVariant &v) {
        node_builder node(v);
 ...
 */
    static inline QVariant
    command_variant(mpv_handle *ctx, const QVariant &args) {
