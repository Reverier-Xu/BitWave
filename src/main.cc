...
int main(int argc, char* argv[]) {
    ...
    QObject::connect(&app, &SingleApplication::receivedMessage, &app_window,
                     &App::onSecondaryInstanceMessageReceived);
    QObject::connect(&app, &SingleApplication::instanceStarted, &app_window,
                     &App::onSecondaryInstanceStarted);
