  ...
  namespace ASF {
    ...
    public:
      ...
      enum Codec
      {
        ...
        /*!
         * Windows MediaModel Audio 1
         */
        WMA1,

        /*!
         * Windows MediaModel Audio 2 or above
         */
        WMA2,

        /*!
         * Windows MediaModel Audio 9 Professional
         */
        WMA9Pro,

        /*!
         * Windows MediaModel Audio 9 Lossless
         */
        WMA9Lossless,
      };
      ...
      /*!
       * Returns the concrete codec name, for example "Windows MediaModel Audio 9.1"
